...
(function(module2, exports2) {
  (function(root, factory) {
    ...
    PubSub2.subscribe = function(message, func) {
      ...
      var token2 = "uid_" + String(++lastUid);
      messages[message][token2] = func;
      return token2;
    };
    ...
    PubSub2.subscribeOnce = function(message, func) {
      var token2 = PubSub2.subscribe(message, function() {
        PubSub2.unsubscribe(token2);
